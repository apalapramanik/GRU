...
├── loss_curve_gru.png       # Training/validation loss
├── accuracy_curve_gru.png   # Training/validation accuracy
├── data/
│   └── wikitext-2-raw/
│       ├── wiki.train.raw
│       ├── wiki.valid.raw
